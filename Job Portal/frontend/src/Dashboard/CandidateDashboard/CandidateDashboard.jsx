  ...
  return (
    <>
      ...
      <div className="flex bg-slate-100">
        <div className="w-[16%] mt-20 fixed">
          <CandidateSidebar />
        </div>
        <div className="md:p-8 p-1   md:ml-[16%]  md:pt-24 pt-24  w-full md:mt-0 ">
          ...
          <div className="flex-col md:flex-row w-auto flex justify-between gap-0">
            <div className="inline-flex mt-10  md:w-[270px] h-[120px] w-[405px] bg-white rounded-lg">
              <div>
                <div className="p-4 mt-7 ml-5 text-3xl bg-sky-100 rounded-md text-sky-600">
                  <BsBriefcaseFill />
                </div>
              </div>

              <div className="md:ml-0 ml-28">
                <h4 className="md:ml-18 ml-20 mt-6 text-3xl font-semibold text-sky-600">
                  22
                </h4>
            ...
            <div className="inline-flex mt-10  md:w-[270px] h-[120px] w-[405px] bg-white md:ml-5 rounded-lg">
              <div>
                <div className="p-4 mt-7 ml-7 text-3xl bg-red-100 rounded-md text-red-600">
                  <BsCardText />
                </div>
              </div>

              <div className="md:ml-0 ml-28">
                <h4 className="ml-16 mt-6 text-3xl font-semibold text-red-600">
                  9382
                </h4>
            ...
            <div className="inline-flex mt-10  md:w-[270px] h-[120px] w-[405px] bg-white md:ml-5 rounded-md">
              <div>
                <div className="p-4 mt-7 ml-7 text-3xl bg-yellow-100 rounded-md text-yellow-400">
                  <BsChatSquareText />
                </div>
              </div>

              <div className="md:ml-0 ml-28">
                <h4 className="ml-20 mt-6 text-3xl font-semibold text-yellow-400">
                  74
                </h4>
            ...
            <div className="inline-flex mt-10  md:w-[270px] h-[120px] w-[405px] bg-white md:ml-5 rounded-lg">
              <div>
                <div className="p-4 mt-7 ml-7 text-3xl bg-green-100 rounded-md text-green-500">
                  <BsBookmark />
                </div>
              </div>

              <div className="md:ml-0 ml-28">
                <h4 className="ml-20 mt-6 text-3xl font-semibold text-green-500">
                  32
                </h4>
          ...
          <div className="md:w-auto flex-col bg-white mt-8 md:ml-[720px] h-[490px] rounded-lg w-[400px] ">
            ...
            <div className="inline-flex ml-3">
              <div className="mt-1 bg-sky-100 rounded-full h-9 w-9">
                <div className="mt-2 ml-[9px] text-sky-700">
                  <TfiBag />
                </div>
              </div>
              <div className="mt-2">
                <p className="font-medium inline-flex ml-2">Henry Wilson </p>{" "}
                applied for a job
                <p className="text-sky-200px md:inline-flex text-sky-700 md:ml-2 ml-2">
                  Product Designer
                </p>
              </div>
            </div>
            ...
            <div className="inline-flex ml-3 mt-4 ">
              <div className="mt-1 bg-sky-100 rounded-full h-9 w-9">
                <div className="mt-2 ml-[9px] text-green-500">
                  <TfiBag />
                </div>
              </div>
              <div className="mt-2">
                <p className="font-medium inline-flex ml-2">Raul Costa </p>{" "}
                applied for a job
                <p className="text-green-200px md:inline-flex text-green-400 md:ml-2 ml-2">
            ...
            <div className="inline-flex ml-3 mt-4">
              ...
              <div className="mt-2">
                <p className="font-medium inline-flex ml-2">Jack Milk </p>{" "}
                applied for a job
                <p className="text-sky-200px md:inline-flex text-sky-700 md:ml-2 ml-2">
                  Technical Architect
                </p>
            ...
            <div className="inline-flex ml-3 mt-4">
              ...
              <div className="mt-2">
                <p className="font-medium inline-flex ml-2">Michel Arian </p>{" "}
                applied for a job
                <p className="text-green-200px md:inline-flex text-green-400 md:ml-2 ml-2">
                  Software Engineer
                </p>
            ...
            <div className="inline-flex ml-3 mt-4">
              ...
              <div className="mt-2">
                <p className="font-medium inline-flex ml-2">Wade Warren </p>{" "}
                applied for a job
                <p className="text-sky-200px md:inline-flex text-sky-700 md:ml-2 ml-2">
                  Web Developer
                </p>
          ...
          <div className="  w-full flex-row  md:p-10 mt-8 md:h-[780px] h-[1410px]  bg-white p-6 ">
            <div>
              <p className="font-semibold text-[20px]  px-4">
                ...
                <div className="  mt-8 md:mt-6 flex h-auto m-3 md:w-[530px] w-full  rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                  <div className="h-full w-full p-5  ">
                    <div className="h-[68%] w-full  flex ">
                      ...
                      <div className="pl-5">
                        <div className="flex justify-between items-center">
                          <NavLink className="  text-[20px] md:text-[19px] font-semibold">
                            {" "}
                            {jobs.title}{" "}
                          </NavLink>
                          <span class="material-symbols-outlined">
                    ...
                    <div className=" flex   py-4 md:ml-[100px]">
                      <div className="h-[33px] w-24 text-center text-white rounded-full bg-blue-400 mr-2">
                        <p className="pt-1">full time </p>
                      </div>
                      <div className="h-[33px] w-24 text-center text-white rounded-full bg-blue-400 mr-2">
                        <p className="pt-1">full time </p>
                      </div>
                      <div className="h-[33px] w-24 text-center text-white rounded-full bg-blue-400 ">
                        <p className="pt-1">full time </p>
                      </div>
                    </div>
                  </div>
