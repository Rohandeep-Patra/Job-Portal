                      ...
                      <div className='h-full w-full p-5 '>
                        <div className='h-[68%] w-full flex'>
                          ...
                          <div className='md:pl-8 pl-5 '>
                            ...
                            <div className=' mt-3'>
                              <button className='rounded-xl bg-sky-100 w-14 h-[30px] pb-1 text-[13px] text-slate-500'>App</button>
                              <button className='rounded-xl bg-sky-100 w-20 h-[30px] pb-1 text-[13px] ml-3 text-slate-500'>Design</button>
                              <button className='rounded-xl bg-sky-100 w-20 h-[30px] pb-1 text-[13px] ml-3 text-slate-500'>Digital</button>
                            </div>
